		...
		<tr>
			<td>
				<div>
					<table>
						<tr>
							<td><i class="fa fa-mortar-board" style="font-size:20px"> Welcome,${user.firstName}</i></b></td>
						</tr>
						<tr>
							<td>
  ...
  <div class="container text-center" style="padding-top: 10px;width: 87%;margin: 0 auto;border-style: double;border-radius: 5px;">
	...
	<div style="padding-top: 25px;padding-bottom:25px;">
		<table id="noticeTable" class="display">
			...
			<tbody>
				 <%int i=1; %>
				  <c:forEach var="obj" items="${listOfAllNotification}">
					<tr>
						<td ><% out.print(i++) ;%>.</td>
						<td align="left">${obj.date}</td>
						<td align="left">${obj.header}</td>
			...
			<div style="padding-bottom: 20px;">
				...
				<div class="row" style="padding-bottom: 15px;">
					...
					<div class="col-sm-3 " style="float: right;">
						<label for="sem"><b>Showing Results For Semester : ${semFiter}</b></label>
					</div>
					</div>
				</div>
			</div>
	  ...
	  <div class="row">
          ...
          <div class="col-sm-4">
          	<div class="well">
          	 ...
          	 <c:forEach var="obj" items="${scores}">
          	 	<c:if test = "${obj.mCount == 1}">
          			<div class="alert alert-success fade in" style="font-size: 16px;"><div>${obj.subject_name}</div><div><strong>${obj.marks}</strong></div></div>
          	 	</c:if>
          	 </c:forEach>
          </div>
          ...
          <div id="div1">
              ...
              <form class="form-horizontal" action="updateUserProfile" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text"  class="form-control" placeholder="Enter Roll Number" value="${user.rollNo}" required readonly/>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">          
                    <input type="text" id="fnameId" name="firstName" class="form-control" placeholder="Enter First name" value="${user.firstName}" required/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">          
                    <input type="text" id="lnameId" name="lastName" class="form-control" placeholder="Enter First name" value="${user.lastName}" required/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">          
                    <input type="text" id="yojId" name="yoj" class="form-control" placeholder="Enter YOJ" value="${user.yoj}" required/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">          
                    <input type="text" id="dobId" name="dob" class="form-control" placeholder="Enter Dob" value="${user.dob}" required/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">          
                    <input type="text" id="emailId" name="email" class="form-control" placeholder="Enter Email" value="${user.email}" required/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">          
                    <input type="text" id="mobNumId" name="mobNum" class="form-control" placeholder="Enter Mobile Number" value="${user.mobNum}" required/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">          
                    <input type="text" id="semId" name="sem" class="form-control" placeholder="Enter Semester" value="${user.sem}" required/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">          
                    <input type="text" id="sectionId" name="section" class="form-control" placeholder="Enter Section" value="${user.section}" required/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">          
                    <select name="branch" id="branchId" style="background-color:#f1f1f1;width:100%;border:0px;padding-top:14px;padding-bottom:14px;">
						<c:forEach var="obj" items="${branchD}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">          
                    <select name="prog" id="progId" style="background-color:#f1f1f1;width:100%;border:0px;padding-top:14px;padding-bottom:14px;">
						<c:forEach var="obj" items="${programmeD}">
							<option value="${obj.key}" >${obj.value}</option>
						</c:forEach>
					</select>
                  </div>
...
<form id="formId1" action="studentDashboard" method="get">
...
function renderUI(){
	var branch_codeVal="${user.branch_name}";
	var programme_codeVal="${user.prog_name}";
