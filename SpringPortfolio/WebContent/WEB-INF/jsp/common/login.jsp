...
<body style="background-color: whitesmoke;">
		...
		<div id="signinDiv" style="width: 35% !important;margin:0 auto;">
			<form id="signin" action="login" method="POST">
			  <div class="container">
				...
				<input type="hidden" name="semFiter" value="0" required>
		...
		<div id="signupDiv" style="width: 35%;margin:0 auto;display:none">
			<form id="singup" action="registerUser" method="POST">
			  <div class="container">
				<h1>Register</h1>
				...
				<input type="number" placeholder="Enter Year of Joining" name="yoj" required>
				...
				<div style="padding-top:15px;padding-bottom:15px">
					...
					<input type="number" placeholder="Enter Mobile Number" name="mobNum" style="background-color:#f1f1f1;width:100%;border:0px;padding-top:14px;padding-bottom:14px;" required>
				</div>
				<label for="psw"><b>Password</b></label>
		...
		<form id="home" method="get" action="welcome"></form>
<script>
