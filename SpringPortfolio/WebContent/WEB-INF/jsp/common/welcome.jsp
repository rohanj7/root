        ...
        <div class="col-sm-12"> 
          <div class="panel panel-default">
            <div class="panel-body">
		        ...
		        <p align="left">
		        	<%@include file="../admin/publication.html"%>
              	</p>
              	</div>
            </div>
          </div>
    ...
    <div class="col-sm-2 well" style="overflow:scroll; height:900px;">
      ...
      <div style="padding-top:10px"></div>
        <c:forEach var="obj" items="${listOfAllNotification}">
	      <div class="thumbnail">
	        <p style="word-break: break-all;">${obj.header}</p>
	        <p style="word-break: break-all;">${obj.description}<br></p>
	        <p style="word-break: break-all;">${obj.date}</p>
	      </div>
       </c:forEach>
